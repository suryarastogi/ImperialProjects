...
public interface WaccParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link WaccParser#array_lit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArray_lit(@NotNull WaccParser.Array_litContext ctx);
	/**
	 * Visit a parse tree produced by {@link WaccParser#start}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStart(@NotNull WaccParser.StartContext ctx);
	/**
