...
public interface WaccParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link WaccParser#array_lit}.
	 * @param ctx the parse tree
	 */
	void enterArray_lit(@NotNull WaccParser.Array_litContext ctx);
	/**
	 * Exit a parse tree produced by {@link WaccParser#array_lit}.
	 * @param ctx the parse tree
	 */
	void exitArray_lit(@NotNull WaccParser.Array_litContext ctx);
	/**
	 * Enter a parse tree produced by {@link WaccParser#start}.
	 * @param ctx the parse tree
	 */
	void enterStart(@NotNull WaccParser.StartContext ctx);
	/**
	 * Exit a parse tree produced by {@link WaccParser#start}.
	 * @param ctx the parse tree
	 */
	void exitStart(@NotNull WaccParser.StartContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterProg(@NotNull WaccParser.ProgContext ctx);
	/**
	 * Exit a parse tree produced by {@link WaccParser#prog}.
	 * @param ctx the parse tree
	 */
	void exitProg(@NotNull WaccParser.ProgContext ctx);
	/**
